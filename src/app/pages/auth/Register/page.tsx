    ...
    <>
      {/* <div className="grid grid-cols-1 md:grid-cols-2 mt-20 w-full">
        <div className="w-fit p-10">
          <h2 className="text-2xl font-md">Register your account</h2>
        </div> */}
            ...
            <div>
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                  <button
                    type="submit"
                    className="rounded-md bg-indigo-600 px-3 py-2 w-full lg:w-60 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Save
                  </button>
                </div>
