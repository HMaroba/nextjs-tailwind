  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 mt-10 w-full lg:space-x-8 p-3 ">
        <div className="h-39 md:h-80 mt-4 lg:mt-1 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white shadow-lg rounded-md p-2 hover:shadow-md">
        ...
        <div className="h-40 md:h-80 mt-4 lg:mt-1 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white shadow-lg rounded-md p-2 hover:shadow-md">
